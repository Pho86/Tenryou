                    ...
                    <div className="flex flex-col justify-center">
                        ...
                        <div className="flex flex-row gap-2">
                            ...
                            <span className="flex gap-1">
                                ...
                                <p className=""><span className="hidden md:block">Abyss:</span> {user.player.abyss.floor}-{user.player.abyss.chamber}</p>
                            </span>
                        </div>
                    </div>
                </div>
                <div className="relative">
                    <Image src={"/icons/namecards.svg"} width={25} height={25} alt="Open Namecards" title="Open Namecards" onClick={() => { setNamecardsHover(!namecardsHover) }} onMouseEnter={() => { setNamecardsHover(true) }} onMouseLeave={() => { setNamecardsHover(false) }} />
                    {namecardsHover &&
                        ...
                        <div className="p-2 flex flex-col gap-2 col-span-1 drop-shadow-text w-full">
                            ...
                            <div className="flex flex-col gap-2 ">
                                ...
                                <div className={`flex gap-2 items-center rounded-xl font-semibold transition-all bg-opacity-75 justify-between ${activeHover === "ELEMENT" && "bg-bg"} py-1 px-2`} onMouseEnter={() => { setActiveHover("ELEMENT") }} onMouseLeave={() => { setActiveHover("") }}>
                                    {activeCharacter.stats.physicalDamageBonus.value > 0 ?
                                        <>
                                            <div className="flex gap-2">
                                            ...
                                            <div className="flex flex-col text-right">
                                                <span className="text-xl">
                                                    {(activeCharacter.stats.physicalDamageBonus.value * 100).toFixed(1)}%
                                                </span>
                                            </div>
                                        </>
                                        :
