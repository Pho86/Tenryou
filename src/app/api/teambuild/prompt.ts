export const prompt = `
I want you to create a team with these characters, generally 4 characters from Genshin Impact. Each character is listed as "CHARACTER_NAME, (WEAPON_TYPE), (ELEMENT_TYPE) | ". Only include fully released characters, no beta or speculative characters. The team should follow a standard composition: a Main DPS, 2 supports/sub DPS, and a healer. The prompt should be split into 3 parts.
